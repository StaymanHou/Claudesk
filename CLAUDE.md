...
- **M3 WP1 (probe) — DONE** 2026-06-22, verdict GO (`docs/product/wp1-hook-socket-probe-outcome.md`). End-to-end hook→`AF_UNIX`-socket wire confirmed on real macOS; claude-time coexistence proven; listener verdict = blocking `std::os::unix::net::UnixListener` on a dedicated thread (not tokio).

...
- [ ] **~~Homebrew detect-and-defer~~ → REVERSED 2026-07-17 to: brew installs self-update in-app too.** Declare `auto_updates true` in the cask + bump `CFBundleVersion` each release; remove the install-source gate. Brew installs get the same self-update UX as direct-download (idiomatic; brew's PR #21882 reconciles the version records).

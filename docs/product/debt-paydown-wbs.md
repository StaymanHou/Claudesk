...
## WP2 — Thread the status-snippet tooltip + git-status path-keying  `[impact: High · effort: Small · risk: Low]`
...
## WP3 — Cross-language menu-id contract pin + picker IPC error-surfacing  `[impact: High · effort: Small-Med · risk: Low]`

...
## Current Node
- **Path:** F-b > Phase 4 > verify-human
- **Active scope:** Phase 4 verify-human (operator: adopt `claude-original-dev` via Settings, set it on a row, open, log in, judge the layout, and the deferred P3.verify-human.1 dot cycle)
- **Blocked:** none

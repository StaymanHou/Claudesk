...
- **Path:** F-b > Phase 4 > build (F12 back-loop, P4.verify-human.1)
- **Active scope:** P4.verify-human.1 rework built + gate green; live re-check, then back to the operator for re-judgment
- **Blocked:** none

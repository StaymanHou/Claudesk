...
stage: arch
state: complete
updated: 2026-09-15  # M15 (workflow supervisor) cycle-closed: index gained arch/workflow-supervisor.md; the guard-arm line corrected to 6 arms / 8 subjects. SPLIT into arch/<subsystem>.md at 2026-08-18 — this file is the index + the warning set.
shape: index
